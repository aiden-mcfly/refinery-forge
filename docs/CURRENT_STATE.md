...
**refinery-forge** turns **canon UTF-8** (embedded, **`--text`**, or **Selah** Postgres) into **SELAHRF1-sealed** v1 **`.bin`** files using the shared **`substrate_interface.h`** rules (**`refinery_emit_substrate_from_text`**), enforces **L-F-02** on substrate (and guarded tank) writes, and owns **L-R-01** / **L-F-03** producer state (**v2** tank, ledger **`flock`**, spectroscopy-reachable single-entry promotion per **G18** / **LAWS.md** v0.16).
